...
def get_travel_base_context():
    ...
    "- **Specific Trip**: When destination/dates/budget are provided, give targeted recommendations\n"
    "- **General Questions**: When no trip details are given, provide broadly applicable advice, "
    "  mention how answers vary by destination/season, and offer to give more specific advice if they share details\n"
    "- **Destination-Only**: If they mention a place but no dates/budget, focus on that destination "
    "  with notes about seasonal variations and typical costs\n"
    "- **No Budget Specified**: Give POPULAR, well-regarded recommendations across price ranges. "
    "  Include approximate prices (e.g., '$15-25 per dish', '$80-150/night') so users can self-filter. "
    "  Don't assume luxury or budget - recommend what's genuinely good and let users decide.\n"
    "\n"
    "RESPONSE GUIDELINES:\n"
